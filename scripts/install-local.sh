...
sed "s#ExecStart=/usr/bin/codexbar-linuxd#ExecStart=$PREFIX/bin/codexbar-linuxd#" \
  "$ROOT/packaging/systemd/codexbar-linuxd.service" > "$HOME/.config/systemd/user/codexbar-linuxd.service"
